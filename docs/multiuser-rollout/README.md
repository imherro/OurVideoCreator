...
P1 已完成内置推理移除并建立独立 Web/Worker 进程边界；P2 已把保留业务切换到 PostgreSQL 唯一主库。P3 正在实现个人身份、团队/作品 ACL 和基础管理页面，继续保持单 Worker、内部试用且不调用真实付费 API；P4 之后的凭证平台化、多 Worker 与公网发布尚未实施。
