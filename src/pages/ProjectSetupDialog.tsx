        ...
        <div className="project-setup-content">
          <section>
            ...
            <div className="two-fields">
              ...
              <label>默认对白方式<select value={draft.dialogueMode} onChange={event=>patch({dialogueMode:event.target.value as ProjectSetupDraft['dialogueMode']})}><option value="voice_sample">音色样本参考</option><option value="full_dialogue">完整对白参考</option></select><small>音色样本仅提供声线，台词以本镜为准。</small></label>
