...
const assets=[{id:'motion',kind:'video',name:'测试动作视频（没有业务素材）'},
 {id:'sample',kind:'audio',name:'测试音色样本（没有业务素材）'}];
...
function App(){
 ...
 return <main style={{padding:20,maxWidth:700,margin:'auto'}}><h1>动作参考隔离测试</h1>
  ...
  <MotionReferenceEditor document={{videoReferenceMode:'multimodal',dialogueMode:'voice_sample',filmBible:{voices:{profiles:{hero:{status:'locked',version:1,referenceVersion:confirmed?1:0,referenceAssetId:'sample'}}}}}} shot={shot} node={{id:'v',data:{model_id:'mock',prompt:'人物走动'}}}
